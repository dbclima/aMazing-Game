...
dados = {
    ...
    "arestas": [
        ...
        {"de": [2, 1], "para": [2, 2], "peso": +2},
        {"de": [2, 2], "para": [3, 2], "peso": -2},
        {"de": [3, 0], "para": [4, 0], "peso": -2},
        {"de": [3, 0], "para": [3, 1], "peso": +5},
        {"de": [3, 1], "para": [4, 1], "peso": -2},
        {"de": [3, 2], "para": [4, 2], "peso": -2},
        {"de": [4, 1], "para": [4, 2], "peso": -2},
        {"de": [4, 2], "para": [4, 3], "peso": -2},
    ],
}
